...
//!
//! This file is copied into an upstream `typst/typst` checkout of the latest
//! release tag as `docs/src/bin/export-api.rs` and compiled as part of the
//! `typst-docs` package. It must compile against the newest stable release;
//! `typst-api-exporter.rs` tracks upstream `main` instead.
